...
def create_augmented_dataloader(args, dataset):
    ...
    # Select 5k random examples from training set for transformation
    num_augmented = 5000
    augmented_examples = original_train.shuffle(seed=42).select(range(num_augmented))
    
    # Apply transformation to the selected examples
    ...
    # Use datasets.concatenate_datasets to combine them
    augmented_train = datasets.concatenate_datasets([original_train, transformed_examples])
